...
The stations marked as 1 in the level field and filled with orange color in the released maps is the stations not marked as "일반역"(一般驿) in the following map.
